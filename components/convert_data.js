export function ConvertCount(Count) {
    ...
    if (Count < 10000000) {
        return (Math.floor(Count / 100000)/10).toString().replace('.', ',')  + ' Tr';
      }
    if (Count < 1000000000) {
      return Math.floor(Count / 1000000).toString() + ' Tr';
    }
    return (Math.floor(Count / 100000000)/10).toString().replace(".", ",") + ' T';
  }
 export function ConvertSub(Count){  
    ...
    if (Count < 10000000) {
        return (Math.floor(Count / 10000)/100).toString().replace('.', ',')  + ' Tr';
        }
    if (Count < 100000000) {
        return (Math.floor(Count / 100000)/10).toString().replace('.', ',')  + ' Tr';
        }
